...
#+attr_html: :width 900px
[[https://i.imgur.com/Hafq4uv.png]]

Now you can go to the ~Repeater~ tab to modify and repeat the request.

In the image we succesfully authenticate by performing an SQL injection.
#+attr_html: :width 900px
[[https://i.imgur.com/kjLxnoD.png]]
